...
namespace Microsoft.EntityFrameworkCore.Query.ResultOperators.Internal
{
    ...
    public class TrackingExpressionNode : ResultOperatorExpressionNodeBase
    {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public static readonly IReadOnlyCollection<MethodInfo> SupportedMethods = new[] { EntityFrameworkQueryableExtensions.AsNoTrackingMethodInfo, EntityFrameworkQueryableExtensions.AsTrackingMethodInfo };
